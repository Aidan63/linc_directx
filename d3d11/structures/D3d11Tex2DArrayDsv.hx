 ...
 */
class D3d11Tex2DArrayDsv
{
    public final backing : Star<NativeD3D11Tex2DArrayDsv>;
    ...
    public function new(_existing : Pointer<NativeD3D11Tex2DArrayDsv> = null)
    {
        if (_existing == null)
        {
            backing = NativeD3D11Tex2DArrayDsv.createPtr();
    ...
    @:void
    static function finalize(_obj : D3d11Tex2DArrayDsv)
    {
...
@:structAccess
@:include('d3d11.h')
@:native('D3D11_TEX2D_ARRAY_DSV')
extern class NativeD3D11Tex2DArrayDsv
{
    @:native('new D3D11_TEX2D_ARRAY_DSV')
    static function createPtr() : Star<NativeD3D11Tex2DArrayDsv>;

    @:native('D3D11_TEX2D_ARRAY_DSV')
    static function createRef() : NativeD3D11Tex2DArrayDsv;
